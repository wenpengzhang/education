...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxca8f832d6c6c732b";//微信开发平台应用id
	public static String APP_SECRET = "4cb0a174231e5be2e718f229960cf887";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1421196802";//财付通商户号
	public static String PARTNER_KEY = "YQApenj7malZW7wXSY1ew6uYyY3ZkcAL";//商户号对应的密钥
