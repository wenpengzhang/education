...
public class HttpsRequest {
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(WeixinConfigure.CERT_LOCAL_PATH));//加载本地的证书进行https加密传输
        try {
            keyStore.load(instream, WeixinConfigure.CERT_PASSWORD.toCharArray());//设置证书密码
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, WeixinConfigure.CERT_PASSWORD.toCharArray())
                .build();
